...
## Podman/Docker Container OS Verification
...
**Common Podman/Docker OS Issues:**
```dockerfile
...
**Verify Containerfile/Dockerfile commands match base image:**
```bash
...
- **Podman/Docker optimization** - Multi-stage builds, layer caching, image size reduction
...
- architecture-expert needs Podman/Docker best practices → consult linux-specialist
- devops-engineer needs zsh/shell script for deployment → consult linux-specialist
- cdk-expert needs Containerfile/Dockerfile optimization → consult linux-specialist

## Podman/Docker Optimization Best Practices
...
**POSIX sh (for portability):**
- Use `[` for conditionals
- Avoid arrays and advanced features

Default to zsh for new scripts on modern systems. when possible for maximum portability.
