...
echo -e "${GREEN}Installing Model Context Protocol (MCP) Servers for Kiro CLI...${NC}\n"
...
echo -e "${YELLOW}Configuring MCP servers for Kiro CLI...${NC}\n"
...
echo -e "${GREEN}✓ Kiro CLI configuration updated: $KIRO_MCP_CONFIG${NC}\n"
...
echo "  • Restart Kiro CLI to load MCP servers"
echo "  • Knowledge graph memory will be stored in ~/.kiro/memory"

echo -e "\n${YELLOW}Usage:${NC}"
echo "  Kiro agents will automatically use these MCPs when needed."
echo "  Examples:"
